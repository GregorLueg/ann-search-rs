...
//!
//! [`quantiser`] holds the one-bit encoder and its query side, [`ex_bits`] the
//! RaBitQ+ magnitude codes on top of it, and [`fastscan`] the batched SIMD
//! scoring path for the sign bits. Under `quantised`, `codec` adds the
